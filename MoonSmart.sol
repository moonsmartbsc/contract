/**
    🌕 MOONSMART 🌕 ----------------------------------------------
    | The innovation of deflated token and never panic sell     |
    | MoonSmart © is a Binance Smart Chain (BSC) token that     |
    | innovate of deflated token and never panic sell.          |
    | With smart token organization mechanism, MoonStar is the  |
    | LaunchPad that all BSC developers needed.                 |
    |                                                           |
    SOCIAL LINK -------------------------------------------------
...
contract MoonSmart is Context, IERC20, Ownable {
    ...
    string private _name = "MoonSmart";
